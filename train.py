...
from trainer import CrcTrainer
...
def main(config):
    ...
    train_barcodes = data_loader.barcode_list[0]
    val_barcodes = data_loader.barcode_list[1]
    barcodes = {"train_barcodes" : train_barcodes, "val_barcodes" : val_barcodes}
    ...
    trainer = CrcTrainer(model, criterion, metrics, optimizer,
                      config=config,
                      device=device,
